...
public class Concepto implements java.io.Serializable {
    ...
    public Concepto(int id, String descripcion, String uuid, BigDecimal precioUnitario, String cantidad, String unidad, String claveUnidad, BigDecimal importe, String claveProd, String impuestos) {
        this.id = id;
